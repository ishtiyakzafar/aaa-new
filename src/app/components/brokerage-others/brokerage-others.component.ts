...
@Component({
	selector: 'app-brokerage-others',
	providers: [BrokerageService],
	templateUrl: './brokerage-others.component.html',
	styleUrls: ['./brokerage-others.component.scss'],
})
export class BrokerageOthersComponent implements OnInit {
	...
	ngOnInit() {
		...
		// 	console.log(obj);
		// 	if (obj && obj['event'] === 'othersEvent') {
		// 		this.clientCode = obj['data']['clientCode'];
		// 		this.getDataFromStorage();
		// 		return;
		// 	} else if (obj && obj['event'] === 'brokerageOthersSearchText' && !this.wait) {
		// 		this.wait = true;
		// 		const temp = obj['data'];
		// 		this.datas = [];
		// 		this.dataLoad = false;
