...
@Component({
	...
	templateUrl: './afyp-health-insurance.component.html',
	styleUrls: ['./afyp-health-insurance.component.scss'],
})
export class AfypHealthInsuranceComponent implements OnInit {
	...
	ngOnInit() {
		...
		// 	if (obj && obj['event'] === 'totalAfypHealthEvent') {
		// 		this.clientCode = obj['data']['clientCode'];
		// 		this.getDataFromStorage();
		// 		return;
		// 	} else if (obj && obj['event'] === 'healthSearchText' && !this.wait) {
		// 		this.wait = true;
		// 		const temp = obj['data'];
		// 		this.datas = [];
		// 		this.dataLoad = false;
