...
@Component({
	selector: 'app-afyp-life-insurance',
	providers: [TotalAFYPService],
	templateUrl: './afyp-life-insurance.component.html',
	styleUrls: ['./afyp-life-insurance.component.scss'],
})
export class AfypLifeInsuranceComponent implements OnInit {
	...
	ngOnInit() {
		...
		// 	if (obj && obj['event'] === 'totalAfypLifeEvent') {
		// 		this.clientCode = obj['data']['clientCode'];
		// 		this.getDataFromStorage();
		// 		return;
		// 	} else if (obj && obj['event'] === 'lifeSearchText' && !this.wait) {
		// 		this.wait = true;
		// 		const temp = obj['data'];
		// 		this.datas = [];
		// 		this.dataLoad = false;
